...
class RequestListener
{
    ...
    public function onPutRequest(GetResponseEvent $getResponseEvent)
    {
        ...
        $this->buildRequestContent($request);
        $this->execute($getResponseEvent);
    }
    ...
    protected function execute(GetResponseEvent $event)
    {
        ...
        curl_setopt($this->curlHandle, CURLOPT_HTTPHEADER, $request::buildHttpHeaders());  
     ...
     * @return string
     */
    protected function buildRequestContent(Request $request)
    {
        /**
         * @todo 
         */
...
//            throw new BadRequestHttpException('Invalid ' . $format . ' message received');
     ...
     * @return string
     */
    protected function buildResponseContent(Request $request)
    {
        /**
         * @todo 
         */
        $encoder = $this->decoderProvider->getDecoder('json');
        $request = $request->getRequest();
